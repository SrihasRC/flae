...
const DEFAULT_COLOR_1 = '#FAF9F5';
const DEFAULT_COLOR_2 = '#CC785C';
const DEFAULT_COLOR_3 = '#EFE9DE';
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uZoom:           { value: 0.9 },
        uColor1:         { value: new Float32Array(hexToRgb(DEFAULT_COLOR_1)) },
        uColor2:         { value: new Float32Array(hexToRgb(DEFAULT_COLOR_2)) },
        uColor3:         { value: new Float32Array(hexToRgb(DEFAULT_COLOR_3)) },
