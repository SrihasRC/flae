...
export default function DocsPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Editorial Header */}
      <section className="pt-12 pb-16 md:pt-16 md:pb-20 border-b border-[#e6dfd8] bg-[#faf9f5]">
      ...
      <section className="py-16 md:py-20 bg-[#faf9f5]">
        <div className="container mx-auto max-w-5xl px-4 sm:px-6 space-y-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-[#3d3d3a] max-w-3xl leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card variant="cream" className="p-4 space-y-2">
                <span className="text-[11px] font-mono text-[#cc785c] font-bold">STAGE 01</span>
                <h3 className="font-semibold text-sm text-[#141413]">Document Parsing</h3>
              ...
              <Card variant="cream" className="p-4 space-y-2">
                <span className="text-[11px] font-mono text-[#cc785c] font-bold">STAGE 02</span>
                <h3 className="font-semibold text-sm text-[#141413]">Fact Extraction</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
              ...
              <Card variant="cream" className="p-4 space-y-2">
                <span className="text-[11px] font-mono text-[#cc785c] font-bold">STAGE 03</span>
                <h3 className="font-semibold text-sm text-[#141413]">Vector Indexing</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
              ...
              <Card variant="cream" className="p-4 space-y-2">
                <span className="text-[11px] font-mono text-[#cc785c] font-bold">STAGE 04</span>
                <h3 className="font-semibold text-sm text-[#141413]">Cross Arbitration</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <Card variant="dark" className="p-6 font-mono text-xs overflow-x-auto space-y-3">
              <div className="flex items-center justify-between border-b border-[#252320] pb-3 text-[#a09d96]">
                <span>ContextEnvelope.json</span>
                <span className="text-[11px]">Strict Typed Schema</span>
              </div>
              <pre className="text-[#faf9f5] leading-relaxed text-[11px]">
{`{
  ...
  "additional_qualifiers": "Full year audited consolidated figures including Spoton Logistics"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-5 rounded-xl border border-[#e6dfd8] bg-[#efe9de] space-y-2">
                <Badge variant="teal" className="text-[10px] font-mono uppercase">
                  CORROBORATED
                </Badge>
                <h3 className="font-semibold text-sm text-[#141413]">Identical Assertions</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
              ...
              <div className="p-5 rounded-xl border border-[#e6dfd8] bg-[#efe9de] space-y-2">
                ...
                <h3 className="font-semibold text-sm text-[#141413]">Genuine Conflict</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
              ...
              <div className="p-5 rounded-xl border border-[#e6dfd8] bg-[#efe9de] space-y-2">
                ...
                <h3 className="font-semibold text-sm text-[#141413]">Divergence Factor Identified</h3>
                <p className="text-xs text-[#6c6a64] leading-relaxed">
            ...
            <div className="pt-2">
              <Link
                ...
                className={cn(
                  ...
                  "text-xs font-semibold px-4 text-[#141413] bg-[#faf9f5]"
                )}
              >
